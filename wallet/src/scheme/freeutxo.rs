...
impl WalletState for UtxoStore<SecretKey<Ed25519Extended>> {
    fn value(&self) -> Value {
        self.total_value()
    }
}
...
impl crate::Wallet for Wallet {
    type State = UtxoStore<SecretKey<Ed25519Extended>>;
